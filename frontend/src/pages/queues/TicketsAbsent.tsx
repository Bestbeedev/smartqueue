              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div className="bg-card p-5 rounded-xl border border-red-200 dark:border-red-800/30 shadow-sm">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">Total des absences</p>
                      <p className="text-2xl font-bold text-foreground">{absentTickets.length}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-card p-5 rounded-xl border border-border shadow-sm">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">Dernière absence</p>
                          ...
                          <tr key={ticket.id} className="hover-card">
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                  <div className="text-lg font-bold text-foreground">{ticket.ticket_number}</div>
